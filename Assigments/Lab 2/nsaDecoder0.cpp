...
{
  //Data
  string objective = "Objective: Prompt the user to enter a line of text, of any length, with spaces and punctuation. Then decode the entered text so that each character is converted to the next character in the ASCII code.\n";
  ...
  //output decoded text
  cout << "Decoded text: " << userText << endl;
